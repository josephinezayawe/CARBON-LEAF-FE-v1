...
const getMenuItems = (t: (key: string) => string) => [
  ...
  {
    title: t("navigation.duplicates"),
    url: "/dashboard/admin/duplicate-management",
    icon: Copy,
  ...
  {
    title: "System Fees",
    url: "/dashboard/admin/system-fees",
    icon: DollarSign,
  ...
  {
    title: t("methodology.sidebar_label"),
    url: "/dashboard/admin/methodologies",
    icon: FlaskConical,
    description: t("methodology.sidebar_description"),
    badge: "",
    badgeVariant: "info" as const,
  },
  {
    title: t("gis.sidebar_label"),
    url: "/dashboard/admin/gis-layers",
    icon: MapPin,
    description: t("gis.sidebar_description"),
    badge: "",
    badgeVariant: "info" as const,
  },
  {
    title: t("baseline.sidebar_label"),
    url: "/dashboard/admin/baselines",
    icon: Gauge,
    description: t("baseline.sidebar_description"),
    badge: "",
    badgeVariant: "info" as const,
  },
  {
    title: t("monitoring.sidebar_label"),
    url: "/dashboard/admin/monitoring-cycles",
    icon: Activity,
    description: t("monitoring.sidebar_description"),
    badge: "",
    badgeVariant: "info" as const,
  },
  {
    title: t("carbon.sidebar_label"),
    url: "/dashboard/admin/carbon-engine",
    icon: Calculator,
    description: t("carbon.sidebar_description"),
    badge: "",
    badgeVariant: "success" as const,
  },
  {
