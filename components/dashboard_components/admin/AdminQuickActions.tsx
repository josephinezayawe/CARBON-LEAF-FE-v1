...
const quickActions = [
  {
    ...
    description: "Check 127 pending credit verifications",
  ...
  },
  {
    ...
    description: "View & manage 12,450 registered users",
  ...
  {
    icon: CreditCard,
    label: "Create Credit Listing",
    description: "Sell credits to companies & buyers",
  ...
  {
    icon: Eye,
    label: "View System Wallet",
    description: "Monitor collected credits & revenue",
  ...
  },
  {
    ...
    description: "Generate system analytics & insights",
    href: "#",
  ...
  },
  {
    ...
    description: "Update fees, percentages & settings",
  ...
  return (
    <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50">
      <CardHeader>
        ...
        <CardDescription>Fast access to common admin tasks</CardDescription>
      </CardHeader>
      <CardContent>
