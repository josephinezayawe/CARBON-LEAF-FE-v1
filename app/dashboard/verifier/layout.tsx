...
import { VerifierSidebar } from "@/components/dashboard_components/verifier/verifier-sidebar";
import {
  SidebarInset,
  SidebarProvider,
  SidebarTrigger,
...
import VerifierBreadcrumb from "@/components/dashboard_components/verifier/VerifierBreadcrumb";
...
export default function VerifierDashboardLayout({
  ...
  return (
    <RoleGuard allowedRoles={["VERIFIER"]} fallback="/signin">
      <DashboardProvider>
        <SidebarProvider>
          <VerifierSidebar />
          <SidebarInset>
