...
import { 
  TreePine, Leaf, ShoppingCart, UserCheck, Menu, X, 
  ArrowRight, CheckCircle, TrendingUp, Globe, Twitter, Linkedin, Github
} from "lucide-react";
...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-emerald-50 via-white to-emerald-25 text-slate-900 overflow-hidden">
      {/* NAV */}
      <header className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between relative z-50">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <div className="flex items-center gap-3 pl-2 border-l border-slate-200">
            <a href="/auth/login" className="text-sm font-medium hover:text-emerald-700 px-2 transition-colors">Log in</a>
            <Button asChild className="shadow-emerald-200/50 shadow-lg hover:shadow-emerald-200/80 transition-all hover:-translate-y-0.5">
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="flex flex-col p-6 gap-4">
              ...
              <a href="/auth/login" className="text-base font-medium hover:text-emerald-700 py-2" onClick={() => setIsMenuOpen(false)}>Log in</a>
              <Button asChild className="w-full">
                <a href="/auth/register" onClick={() => setIsMenuOpen(false)}>Get Started</a>
              </Button>
            </nav>
          </motion.div>
        )}
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 lg:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            <Button asChild size="lg" className="h-12 px-8 text-base shadow-emerald-200 shadow-lg hover:shadow-xl hover:shadow-emerald-200/60 transition-all hover:-translate-y-1">
              <a href="/register">Start planting <ArrowRight className="ml-2 w-4 h-4" /></a>
            </Button>
            <a href="#how" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 text-slate-700 text-sm font-medium hover:bg-slate-50 hover:border-emerald-200 hover:text-emerald-700 transition-all">
          ...
          >
            {[
              ...
              >
                ...
                <p className="mt-1 text-2xl font-bold text-emerald-900 group-hover:text-emerald-600 transition-colors">{stat.val}</p>
              </motion.div>
            ))}
          </motion.div>
        </motion.div>
            ...
            >
              <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] border border-white/50 flex items-center gap-4 hover:scale-105 transition-transform duration-300">
                 ...
                 <div className="flex-1 min-w-0">
                   ...
                   <p className="text-sm font-bold text-slate-900 truncate">Riverbank Reforestation</p>
                   <div className="flex items-center gap-3 mt-1">
                     <div className="flex items-center gap-1">
                       <Leaf className="w-3 h-3 text-emerald-600" />
                       <span className="text-xs text-slate-600 font-medium">120 Trees</span>
                     </div>
                   </div>
                 </div>
                 <Button size="icon" className="w-8 h-8 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-200">
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-16 lg:py-24 relative overflow-hidden">
        ...
        >
            <h3 className="text-3xl font-bold text-slate-900">What makes CarbonLeaf different</h3>
            <p className="mt-4 text-slate-600 text-lg">We bridge the gap between small-scale land stewards and global carbon markets with technology that ensures transparency.</p>
        </motion.div>
      ...
      {/* HOW IT WORKS */}
      <section id="how" className="bg-slate-50 border-y border-slate-200 relative">
      ...
      <section id="pricing" className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold leading-tight">Ready to make a <br/>real impact?</h3>
            <p className="mt-6 text-emerald-100 text-lg max-w-md">Join hundreds of companies and thousands of projects making a real difference today.</p>
            <ul className="mt-8 space-y-4">
                <li className="flex items-center gap-3 text-emerald-50 font-medium">
                    <div className="bg-emerald-800/50 p-1.5 rounded-full"><Leaf className="w-4 h-4 text-emerald-300" /></div>
                    <span>Verified Carbon Credits</span>
                </li>
                <li className="flex items-center gap-3 text-emerald-50 font-medium">
                    <div className="bg-emerald-800/50 p-1.5 rounded-full"><UserCheck className="w-4 h-4 text-emerald-300" /></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-end relative z-10 mt-4 md:mt-0">
             <Button size="lg" variant="secondary" className="h-14 px-8 text-lg text-emerald-950 font-bold hover:bg-emerald-50 hover:scale-105 transition-all duration-300" asChild>
               <a href="/marketplace">Explore Marketplace</a>
             </Button>
             <Button size="lg" variant="outline" className="h-14 px-8 text-lg border-emerald-700/50 bg-emerald-900/50 backdrop-blur-sm text-white hover:bg-emerald-800 hover:text-white hover:border-emerald-600 transition-all duration-300" asChild>
      ...
      <footer className="bg-white border-t border-slate-100 pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-600">
              <li><a href="#features" className="hover:text-emerald-600 transition-colors block">Features</a></li>
              <li><a href="#how" className="hover:text-emerald-600 transition-colors block">How it works</a></li>
              <li><a href="/dashboard" className="hover:text-emerald-600 transition-colors block">Dashboard</a></li>
              <li><a href="/marketplace" className="hover:text-emerald-600 transition-colors block">Marketplace</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-600">
              <li><a href="#" className="hover:text-emerald-600 transition-colors block">About us</a></li>
              <li><a href="#" className="hover:text-emerald-600 transition-colors block">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-emerald-600 transition-colors block">Terms of Service</a></li>
              <li><a href="#" className="hover:text-emerald-600 transition-colors block">Contact</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-400 text-sm">
            ...
            <div className="flex gap-6">
                ...
                <a href="#" className="hover:text-emerald-600 transition-colors"><Linkedin className="w-5 h-5" /></a>
